...
AS $$
DECLARE
  project_url TEXT := 'https://wnyyjjvhezonohugkwen.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndueXlqanZoZXpvbm9odWdrd2VuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMzQ1NDczNywiZXhwIjoyMDI5MDMwNzM3fQ.8HEVmDPNCc2T5QwhSvip0v2tRaAOze7h-SvX2CnPH48'; -- full access needed for http request to storage
